...
export default function Hero() {
  return (
    <section id="hero" className="w-full pt-40 md:pt-56 pb-12 px-4 min-h-[80vh] flex items-center justify-center bg-transparent">
      <div
        className="max-w-7xl mx-auto w-full text-white flex flex-col md:flex-row items-center justify-center rounded-3xl p-8 md:p-16 md:-mt-24 theme-minimal-surface backdrop-blur border border-white/10 shadow-2xl"
      >
        {/* Left Side */}
        <div className="flex-1 flex flex-col items-center justify-center text-center">
          ...
          >
            Hi, I'm{" "}
            <span className="theme-minimal-accent">Joel Leah</span>
          </motion.h1>
          <motion.div
          ...
          <div className="w-full flex justify-center">
            <Link to="projects" smooth={true} duration={500} offset={-70}>
              <motion.button
                className="text-white font-semibold px-8 py-3 rounded-full shadow-lg transition bg-white/10 hover:bg-white/15 border border-white/15"
        ...
        <div className="flex-1 flex justify-center items-center mb-8 md:mb-0">
          <motion.img
            src={profileImg}
            alt="Joel Leah"
            className="w-64 h-64 md:w-80 md:h-80 object-cover rounded-3xl shadow-xl border border-white/15"
